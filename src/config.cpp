...
// Number of objects.
const unsigned usr::count = 200;          // Number of balls.

// Physical parameters.
const float usr::mass = 100.0f;           // Mass of a ball.
...
const float usr::tank_distance = 60.0f;   // Distancia del ojo a la pantalla.
...
// Program name.
const char * const usr::window_name = "Convex uniform polyhedra";
